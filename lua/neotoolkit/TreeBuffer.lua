...
---@alias neotoolkit.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean):string[][], string[][]
...
---@param tree neotoolkit.Tree
---@param starting_id any?  -- nil = whole tree
---@return neotoolkit.Tree.FlatNode[]
...
---@private
---@param flatnode neotoolkit.Tree.FlatNode
---@param row integer
...
---@param new_flat neotoolkit.Tree.FlatNode[]
...
---@private
---@return any?, neotoolkit.TreeBuffer.ItemData?
