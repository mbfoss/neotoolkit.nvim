...
local LRU = require("neotoolkit.LRU")

local M = {}

-- PCRE2 compile options (subset). See pcre2_compile(3).
---@enum neotoolkit.regex.opt
M.opt = {
	CASELESS = 0x00000008,
...
---@enum neotoolkit.regex.match_opt
M.match_opt = {
	NOTBOL = 0x00000001,
	NOTEOL = 0x00000002,
	NOTEMPTY = 0x00000004,
...
---@param flags string|integer|nil flag chars ("imsxuUA"), raw option bits, or nil
---@return neotoolkit.Regex? regex, string? err
